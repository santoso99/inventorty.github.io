...
@section('title', 'Riwayat APD Ambil')
...
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <h1 class="d-xl-none d-md-none">APD Ambil</h1>
            ...
            <div class="breadcrumb-item"><a href="{{route('barang.ambil.index')}}"> APD Ambil</a>
            </div>
                          ...
                          <tr>
                            <td colspan="7">
                              <div class="empty-state" data-height="400" style="min-height: 400px;">
                                ...
                                <h2>Tidak ada riwayat hapus dari APD Ambil!</h2>
                              </div>
                            </td>
                          </tr>
