                ...
                <div class="notif">
                    ...
                    <div class="col-6">
                        <a href="{{ route('konfirmasi_pengambilan') }}" class="notif-container">
                            ...
                            <span class="mt-3">Konfirmasi pengambilan APD</span>
                        </a>
                    </div>
                </div>
                {{-- <div class="dropdown-header">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                <div class="notif">
                    <div class="col-6">
                        <a href="{{ route('cart_pinjam') }}" class="notif-container">
                            ...
                            <span class="mt-3">Notifikasi Peminjaman APD</span>
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="{{ route('cart_ambil') }}" class="notif-container">
                            ...
                            <span class="mt-3">Notifikasi pengambilan APD</span>
                        </a>
                    </div>
                </div>
                {{-- <div class="dropdown-header">
                ...
                <div class="dropdown-list-content dropdown-list-icons is-end" tabindex="3" style="height:auto; overflow: hidden; outline: none;">
                    <a href="{{ route('cart_pinjam') }}" class="dropdown-item border-top">
                        ...
                        <div class="dropdown-item-desc">
                            Peminjaman
                            <div class="time">Notifikasi untuk data peminjaman barang.</div>
                        </div>
                    </a>
                    <a href="{{ route('cart_ambil') }}" class="dropdown-item border-top">
                        ...
                        <div class="dropdown-item-desc">
                            Pengambilan
                            <div class="time">
                                Notifikasi untuk data pengambilan barang.
                            </div>
                        </div>
                    </a>
                </div> --}}
