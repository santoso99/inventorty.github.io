    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-12 col-12 order-lg-1 min-vh-100 order-md-1 bg-white">
          <div class="p-4 m-3">
            <img src="{{asset('img/auth-login.jpg')}}" alt="logo" width="200" class="mb-2 mt-2">
            ...
            <div class="text-center mt-5 text-small">
                Copyright &copy; <span id="tahun"></span> Inventory
            </div>
          </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    <div class="login-brand card-primary">
                        <img width="250" alt="image" src="{{asset('img/auth-login.jpg')}}" class="rounded-circle mr-1" style="border:6px solid white;">
