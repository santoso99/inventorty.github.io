...
<section class="section">
    ...
    <div class="section-header">
        ...
        <h1 class=" d-xl-none d-md-none">Riwayat pengambilan APD</h1>
        <div class="section-header-breadcrumb ml-md-0 d-none d-md-flex">
            ...
            <div class="breadcrumb-item">Riwayat pengambilan APD</div>
        </div>
    </div>
    ...
    <div class="section-body">
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Data Riwayat pengambilan APD</h4>
                    </div>
