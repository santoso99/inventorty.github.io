...
<section class="section">
    ...
    <div class="section-header">
        ...
        <h1 class=" d-xl-none d-md-none">Konfirmasi pengambilan APD</h1>
        <div class="section-header-breadcrumb ml-md-0 d-none d-md-flex">
            ...
            <div class="breadcrumb-item">Konfirmasi pengambilan APD</div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Data Konfirmasi pengambilan APD</h4>
                    </div>
                    <div class="card-body">
